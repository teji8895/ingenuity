    ...
    render(){
        return(
            ...
            <Footer color="unique-color-dark" className="page-footer font-small pt-0">
                ...
                <div style={{backgroundColor: '#6ec7eb'}}>
                ...
                <Container className="mt-5 mb-4 text-center text-md-left">
                    <Row className="mt-3">
                        <Col md="3" lg="4" xl="3" className="mb-4">
                            <h6 className="text-uppercase font-weight-bold"><strong>COMPANY</strong></h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p>EQMS India Pvt. Ltd</p>
                        </Col>
                        <Col md="2" lg="2" xl="2" className="mb-4">
                            <h6 className="text-uppercase font-weight-bold"><strong>Our Services</strong></h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p><a href="#!">EIA Services</a></p>
                            <p><a href="#!">Environment health & safety</a></p>
                            <p><a href="#!">training Courses</a></p>
                            <p><a href="#!">EHS Auditing Services</a></p>
                        </Col>
                        ...
                        <Col  md="4" lg="3" xl="3" className="mb-4">
                            <h6 className="text-uppercase font-weight-bold"><strong>Contact Us</strong></h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p><i className="fa fa-home mr-3"></i> EQMS India Pvt. Ltd</p>
                            <p><i className="fa fa-envelope mr-3"></i> 304-305, 3rd Floor, Rishabh Tower</p>
                            <p><i className="fa fa-phone mr-3"></i>Plot No. 16, Community Centre,
Karkardooma, Delhi- 110092 (India)</p>
                            <p><i className="fa fa-print mr-3"></i>Phone 
+91-11-30003200-19</p>
                        </Col>
                    </Row>
                </Container>
                <div className="footer-copyright text-center">
                    <Container fluid   style={{fontSize:'15px'}} >
                        &copy; {(new Date().getFullYear())} Copyright: <a rel="noopener noreferrer" href="http://www.eqmsindia.com/"  target="_blank"> eqmsindia.com </a>
                    </Container>
                </div>
            </Footer>
        );
